...
Before writing, check the kill list in [references/kill-list.md](references/kill-list.md) for phrases and patterns to avoid.
...
See [references/examples.md](references/examples.md) for before/after demonstrations of these rules in action.
