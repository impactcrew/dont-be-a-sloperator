...
### No em dashes
Never use em dashes. Use commas, periods, or restructure the sentence. Em dashes are the single most reliable tell that text was AI-generated. Exception: box-drawing characters (├── └── │) are not em dashes. Leave them alone.
